...
<head>
    ...
    <title>View Active Products</title>
    ...
    <div class="main-container">
        ...
        <section class="show-post">
            ...
            <div class="box-container">
                <?php
                // Prepare the SQL statement to select active products
                $select_products = $conn->prepare("SELECT * FROM `product` WHERE seller_id = ? AND status = 'active'");
